...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>PELANGGARAN MEMBER</b></span>
    </a>
        ...
        <?php }*/ ?>
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <i class="glyphicon glyphicon-search"></i> Cari Member
            </a>
            <ul class="dropdown-menu" style="border-bottom: 2px solid#aaa;">
              <li class="header text-center">Masukkan NIS Atau NAMA Member</li>
              <li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img src="<?php echo $base; ?>php/img/logo lbh baru.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $na['nama'] ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo $base; ?>php/img/logo lbh baru.jpg" class="img-circle" alt="User Image">
                <p>
                  <?php echo $na['nama']; ?>
                  <small></small>
                </p>
      ...
      <ul class="sidebar-menu">
        ...
        <li <?php echo $gak; ?>>
          <a href="<?php echo $basead; ?>pelanggaransiswa">
            <i class="glyphicon glyphicon-remove-circle"></i> <span>Pelanggaran Member</span>
          </a>
        </li>
        ...
        <li <?php echo $dak; ?>>
          <a href="<?php echo $basead; ?>siswa">
            <i class="glyphicon glyphicon-education"></i> <span>Member</span>
          </a>
        </li>
        <li <?php echo $eak; ?>>
          <a href="<?php echo $basead; ?>guru">
            <i class="glyphicon glyphicon-blackboard"></i> <span>Conseling</span>
          </a>
        </li>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="#">LANGUAGE BOARDING HOUSE(LBH) (Tlp.082334605141 )</a></strong> by Fauziatur Rofiko
  </footer>
  <!-- Control Sidebar -->
