...
<div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='edit'){?>
          <div style="display: none;" class="alert alert-success alert-dismissable">Conseling Berhasil Diedit
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Data Guru</h3><span style="float:right;"><a href="<?php echo $basead.'guru'; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Conseling</a></span>
            </div>
            <!-- form start -->
