      <div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='hapus'){?>
          <div style="display: none;" class="alert alert-danger alert-dismissable">Conseling Berhasil Dihapus
        ...
        <?php $_SESSION['pesan'] = '';?>
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"></span>&nbsp;Seluruh Conseling</h3><span style="float:right;"><a href="<?php echo $basead; ?>addguru" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-plus"></i> Tambah Conseling</a></span>
            </div>
            <!-- /.box-header -->
