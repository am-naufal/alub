...
<div class="row">
        ...
        <?php if(isset($_SESSION['pesan']) && $_SESSION['pesan']=='tambah'){?>
          <div style="display: none;" class="alert alert-success alert-dismissable">Member Berhasil Ditambahkan
        ...
        <?php } $_SESSION['pesan'] = '';?>
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Tambah Member Kelas <?php echo $dkelas['kelas']; ?></h3><span style="float:right;"><a href="<?php echo $basead.'siswa/'.$_GET['q']; ?>" class="btn btn-circle btn-primary"><i class="glyphicon glyphicon-th-list"></i> Lihat Member</a></span>
            </div>
            <!-- form start -->
            ...
            <input type="hidden" name="c_kelas" value="<?php echo $_GET['q']; ?>">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-success btn-circle"><i class="glyphicon glyphicon-ok"></i> Simpan Member</button>
              </div>
            </form>
          </div>
          <!-- /.box -->
